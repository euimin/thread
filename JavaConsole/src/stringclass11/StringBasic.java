...
public class StringBasic {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("==(비교연산자)로 주소 비교:"+(str1==str2));
		...
		String str3="WORLD";		
		String str4="WORLD";
		System.out.println("==로 주소비교:"+( str3 == str4));//true
		System.out.println("equals()로 문자열비교:"+str3.equals(str4));
		/*
